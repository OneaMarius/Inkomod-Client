        ...
        <div className={styles.container}>
                ...
                <div className={styles.gridContainer}>
                    {inventory.lootSlots.map((loot, index) => (
                        <div key={`loot-${index}`} className={styles.inventoryCard}>
                            <div className={styles.itemInfo}>
                                <div className={styles.itemName}>
                                    {loot.itemName || loot.entityName || loot.name}
                                </div>
                                <div className={styles.itemClass}>
                                    <div>
                                        Type: {loot.classification?.itemClass || loot.classification?.entityClass || 'Trade Good'}
                                    </div>
                                    <div>
                                        Mass:{' '}
                                        {loot.stats?.mass ||
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        setItemToDrop({
                                            ...
                                            arrayName: 'lootSlots', // Asta trimite catre functia doDropItem corecta
                                        });
                                        setIsDropModalOpen(true);
                                    }}
                                >
            ...
            <div className={styles.debugContainer}>
                ...
                <div className={styles.debugButtons}>
                    ...
                    <Button onClick={debugGenerateLoot} variant='secondary'>
                        + Gen Loot
                    </Button>
                </div>
            </div>
