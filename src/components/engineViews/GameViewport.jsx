...
const GameViewport = ({ onExploreComplete }) => {
    ...
    // NEW: Extract the dynamic exchange rate from the state
    ...
    const handleActionClick = (actionTag, npcId) => {
        ...
        // NEW: We pass the exchangeRate here so the engine knows the current economy
    ...
    return (
        <div className={styles.viewportContainer}>
            <div className={styles.header}>
                ...
                {/* NEW: Regional Exchange Rate Display */}
                <p style={{ 
