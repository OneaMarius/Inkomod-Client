        ...
        <div className={styles.modalOverlay} onClick={handleOverlayClick}>
            <div className={styles.modalContent}>
                <div className={styles.container}>
                    ...
                    <h3 className={`${styles.subHeader} ${styles.debugHeader}`}>
                        DEBUG: Manipulate Stats
                    </h3>
                    <div className={styles.debugContainer}>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('progression', 'honor', -5)}>Honor -5</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('progression', 'honor', 5)}>Honor +5</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('progression', 'renown', -50)}>Renown -50</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('progression', 'renown', 50)}>Renown +50</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('stats', 'str', -10)}>STR -10</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('stats', 'str', 10)}>STR +10</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('stats', 'agi', -10)}>AGI -10</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('stats', 'agi', 10)}>AGI +10</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('stats', 'int', -10)}>INT -10</button>
                        <button className={styles.debugBtn} onClick={() => debugModifyStat('stats', 'int', 10)}>INT +10</button>
                    </div>
