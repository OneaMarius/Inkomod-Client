	...
	return (
		<>
			<div
				...
				onClick={() => {
					setIsActiveLoadoutOpen(!isActiveLoadoutOpen);
					playImmediateSound(soundPath, volumeLevel);
				}}
			>
				...
				<div className={styles.headerRightGroup}>
					<div className={styles.loadoutIndicators}>
						<div
							className={`${styles.loadoutSquare} ${equipment.hasWeapon ? styles.loadoutSquareEquipped : styles.loadoutSquareEmpty}`}
							title='Weapon'
						>
							W
						</div>
						<div
							className={`${styles.loadoutSquare} ${equipment.hasShield ? styles.loadoutSquareEquipped : styles.loadoutSquareEmpty}`}
							title='Shield'
						>
							S
						</div>
						<div
							className={`${styles.loadoutSquare} ${equipment.hasArmor ? styles.loadoutSquareEquipped : styles.loadoutSquareEmpty}`}
							title='Armor'
						>
							A
						</div>
						<div
							className={`${styles.loadoutSquare} ${equipment.hasHelmet ? styles.loadoutSquareEquipped : styles.loadoutSquareEmpty}`}
							title='Helmet'
						>
							H
						</div>
						<div
							className={`${styles.loadoutSquare} ${equipment.hasMount ? styles.loadoutSquareEquipped : styles.loadoutSquareEmpty}`}
							title='Mount'
						>
							M
						</div>
