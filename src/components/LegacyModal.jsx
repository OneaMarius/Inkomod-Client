...
const LegacyModal = ({ knight, closeDetails, handleImgError }) => {
    // Debugging (poți păstra sau șterge după ce te convingi că merge)
    useEffect(() => {
        if (knight) {
        ...
        >
            ...
            >
                ...
                <div className={styles.modalHeader}>
                    <div className={styles.dualIdentityContainer}>
                        ...
                        <div className={styles.profileBox}>
                            <img
                                src={`/avatars/${knight.playerAvatar}`}
                        ...
                        <div className={styles.profileBox}>
                            <img
                                src={`/avatars/${knight.knightAvatar}`}
                                className={styles.mediumAvatar}
                ...
                <div className={styles.modalBody}>
                    ...
                    {/* --- THE FALL (CIRCUMSTANCES OF DEATH) --- */}
                    ...
                    {knight.killerName !== 'None' && (
                        <div className={styles.statRow}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <span className={styles.statValue}>{knight.killerName}</span>
                                <img
                                    src={`/avatars/${knight.killerAvatar}`}
