...
export const generateHumanNPC = (subclassKey, poiRank) => {
	...
	// --- INTEGRATE UNIVERSAL ACTION TAGS ---
	const specificTags = profile.actionTags || [];
	const universalTags = DB_NPC_TAXONOMY.actions.universalTags.humanoid || [];
	const combinedTags = [...new Set([...specificTags, ...universalTags])];
