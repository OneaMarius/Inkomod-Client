...
export const executeInteraction = (playerEntity, actionTag, targetId, regionalExchangeRate = 10) => {
	...
	if (
		...
		return { status: 'TRIGGER_COMBAT', targetId: targetId, apSpent: apCost, updatedPlayer: playerEntity };
	}
	...
	if (actionTag.startsWith('Trade_') || ['Trade', 'Buy_Animal', 'Sell_Animal', 'Repair_Equipment'].includes(actionTag)) {
		playerEntity.progression.actionPoints -= apCost;
