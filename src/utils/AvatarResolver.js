...
export const getEntityAvatar = (entityCategory, entityClass, entitySubclass) => {
	...
	const SUPPORTED_HUMAN_SUBCLASSES = ['blacksmith'];

	// 1. Prioritate maximă: Subclasa
	if (actualSubclass && actualSubclass !== 'Unknown' && actualSubclass !== 'None' && actualSubclass !== '') {
	...
	if (actualClass && actualClass !== 'Unknown' && actualClass !== 'None' && actualClass !== '') {
