            ...
            choices: [
                {
                    ...
                    onFailure: {
                        description: 'The undead overwhelmed you, leaving you severely injured.',
                        hpMod: { tier: 'MAJOR', type: 'PENALTY' },
                    },
                },
            ],
            ...
            choices: [
                {
                    ...
                    onSuccess: {
                        description: "The bear decides you aren't worth the trouble and leaves.",
                        renown: { tier: 'MINOR', type: 'REWARD' },
                    },
                    onFailure: {
            ...
            choices: [
                {
                    ...
                    onFailure: {
                        description: 'The beast fought back fiercely before escaping.',
                        hpMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                },
                {
            ...
            choices: [
                {
                    ...
                    onFailure: {
                        description: 'You lost the bout, taking a few bruises to your ego and body.',
                        hpMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                },
                {
            ...
            choices: [
                {
                    ...
                    onFailure: {
                        description: 'The mold spores make you sick, and the items disintegrate.',
                        hpMod: { tier: 'MODERATE', type: 'PENALTY' },
                    },
                },
            ],
            ...
            choices: [
                {
                    ...
                    difficultyModifier: 1,
                    onSuccess: {
                        description: 'You carefully extract the medicinal properties.',
                        healingPotions: { tier: 'MINOR', type: 'REWARD' },
                    },
                    onFailure: {
                        description: 'You mishandle them and get a nasty chemical burn.',
                        hpMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                },
            ],
            ...
            choices: [
                {
                    ...
                    onFailure: {
                        description: 'You cut your hand on rusty iron and find nothing.',
                        hpMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                },
            ],
            ...
            choices: [
                {
                    ...
                    onFailure: {
                        description: 'You jam your fingers trying to force it. The box remains sealed.',
                        hpMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                },
            ],
            ...
            choices: [
                {
                    ...
                    difficultyModifier: -1,
                    onSuccess: {
                        description: 'You quickly stitch it together, losing minimal time.',
                        apMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                    onFailure: {
            ...
            choices: [
                {
                    ...
                    successChance: 70,
                    onSuccess: {
                        description: 'The path is clear and saves you significant time.',
                        apMod: { tier: 'MAJOR', type: 'REWARD' },
                    },
                    onFailure: {
                        description: 'The trail ends at a ravine. You have to backtrack.',
                        apMod: { tier: 'MODERATE', type: 'PENALTY' },
                    },
                },
            ],
            ...
            choices: [
                {
                    ...
                    difficultyModifier: 0,
                    onSuccess: {
                        description: 'You quickly find a landmark and get back on track.',
                        apMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                    onFailure: {
                        description: 'You wander aimlessly for hours, exhausting yourself.',
            ...
            choices: [
                {
                    ...
                    difficultyModifier: 0,
                    onSuccess: {
                        description: 'You carefully take the trap apart and keep the components.',
                        procGen: { items: [{ category: 'Loot', count: 2 }] },
                    },
                    onFailure: {
                        description: 'The mechanism snaps, destroying the parts but leaving you unharmed.',
                        apMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                },
            ],
            ...
            choices: [
                {
                    ...
                    difficultyModifier: 0,
                    onSuccess: {
                        description: 'You confuse the drunkard long enough to slip past safely.',
                        apMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                    onFailure: {
                        description: 'They swing wildly, striking you before passing out.',
                        hpMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                },
            ],
        ...
        // --- EVENT TYPE: POSITIVE ---
        {
            ...
            choices: [
                ...
                },
                {
                    ...
                    checkType: 'GENERAL',
                    onSuccess: {
                        description: 'You protect your supplies, but feel a twinge of guilt.',
                        honor: { tier: 'MODERATE', type: 'PENALTY' },
                    },
                },
            ],
            ...
            choices: [
                {
                    ...
                    difficultyModifier: 0,
                    onSuccess: {
                        description: 'Your mind expands from the profound conversation.',
                        int: { tier: 'MINOR', type: 'REWARD' },
                    },
                    onFailure: {
                        description: 'The conversation goes over your head. You just waste time.',
                        apMod: { tier: 'MINOR', type: 'PENALTY' },
                    },
                },
            ],
