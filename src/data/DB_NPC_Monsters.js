...
export const DB_NPC_MONSTERS = {
    ...
    Undead_Warrior: {
        classification: {
            ...
            entityCategory: 'Monster',
            entityClass: 'Undead',
            entitySubclass: 'Undead_Warrior',
        },
        behavior: {
            behaviorState: 'Hostile',
            isAlert: true,
            fleeHpPercentThreshold: 0.00, // Undead do not flee
        },
        logistics: {
            resourceTag: 'Trophy',
        ...
        economy: {
            baseCoinValue: 0,
            lootTableId: 'loot_monster_undead',
        },
        generationProfile: {
            rankRange: [1, 5],
    ...
    Giant_Spider: {
        classification: {
            ...
            entityCategory: 'Monster',
            entityClass: 'Beast',
            entitySubclass: 'Giant_Spider',
        },
        behavior: {
            behaviorState: 'Hostile',
            isAlert: true,
            fleeHpPercentThreshold: 0.25,
        },
        logistics: {
            resourceTag: 'Monster_Parts',
        ...
        economy: {
            baseCoinValue: 0,
            lootTableId: 'loot_monster_spider',
        },
        generationProfile: {
            rankRange: [1, 5],
    ...
    Goblin_Scavenger: {
        classification: {
            entityArchetype: 'Creature',
            entityCategory: 'Monster',
            entityClass: 'Goblinoid',
            entitySubclass: 'Goblin_Scavenger',
        },
        behavior: {
            behaviorState: 'Hostile',
            isAlert: true,
            fleeHpPercentThreshold: 0.40, // High flee tendency
        },
        logistics: {
            resourceTag: 'Monster_Parts',
        ...
        economy: {
            baseCoinValue: 0,
            lootTableId: 'loot_monster_goblin',
        },
        generationProfile: {
            rankRange: [1, 5],
