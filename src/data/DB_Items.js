...
export const DB_ITEM_NOMENCLATURE = {
	...
	lootPools: {
		Human: [
			{ name: 'Coin Pouch', prefixes: ['Empty', 'Light', 'Standard', 'Heavy', 'Bulging'] },
			{ name: 'Signet Ring', prefixes: ['Brass', 'Copper', 'Silver', 'Gold', 'Jeweled'] },
			{ name: 'Brooch', prefixes: ['Tarnished', 'Iron', 'Silver', 'Ornate', 'Exquisite'] },
			{ name: 'Medallion', prefixes: ['Chipped', 'Bronze', 'Silver', 'Gilded', 'Pristine'] },
			{ name: 'Chalice', prefixes: ['Wooden', 'Pewter', 'Silver', 'Golden', 'Bejeweled'] },
			{ name: 'Gemstone', prefixes: ['Flawed', 'Cloudy', 'Clear', 'Radiant', 'Flawless'] },
			{ name: 'Ivory Comb', prefixes: ['Broken', 'Scratched', 'Smooth', 'Carved', 'Masterwork'] },
			{ name: 'Necklace', prefixes: ['String', 'Beaded', 'Silver', 'Gold', 'Diamond'] },
		],
		Animal: [
			{ name: 'Pelt', prefixes: ['Matted', 'Ragged', 'Standard', 'Thick', 'Pristine'] },
			{ name: 'Hide', prefixes: ['Scarred', 'Tough', 'Cured', 'Flawless', 'Legendary'] },
			{ name: 'Fang', prefixes: ['Chipped', 'Dull', 'Sharp', 'Cruel', 'Massive'] },
			{ name: 'Claw', prefixes: ['Broken', 'Worn', 'Curved', 'Razor', 'Lethal'] },
			{ name: 'Horn', prefixes: ['Splintered', 'Scraped', 'Solid', 'Polished', 'Majestic'] },
			{ name: 'Tusk', prefixes: ['Cracked', 'Yellowed', 'Heavy', 'Ivory', 'Immaculate'] },
			{ name: 'Antler', prefixes: ['Snapped', 'Small', 'Branched', 'Grand', 'Crowned'] },
			{ name: 'Gland', prefixes: ['Dried', 'Weak', 'Potent', 'Pulsing', 'Prime'] },
		],
		Monster: [
			{ name: 'Ichor', prefixes: ['Watery', 'Foul', 'Thick', 'Glowing', 'Pure'] },
			{ name: 'Scale', prefixes: ['Cracked', 'Dull', 'Hardened', 'Iridescent', 'Adamantine'] },
			{ name: 'Venom Sac', prefixes: ['Shriveled', 'Leaking', 'Full', 'Potent', 'Lethal'] },
			{ name: 'Heart', prefixes: ['Rotten', 'Cold', 'Beating', 'Cursed', 'Immortal'] },
			{ name: 'Bone', prefixes: ['Splintered', 'Brittle', 'Heavy', 'Blackened', 'Unbreakable'] },
			{ name: 'Eye', prefixes: ['Blind', 'Glassy', 'Staring', 'Piercing', 'All-Seeing'] },
			{ name: 'Talon', prefixes: ['Dull', 'Jagged', 'Cruel', 'Shadow', 'Nightmare'] },
			{ name: 'Marrow', prefixes: ['Dry', 'Oozing', 'Crystallized', 'Glowing', 'Ethereal'] },
		],
		Nephilim: [
			{ name: 'Shard', prefixes: ['Dim', 'Fractured', 'Resonant', 'Luminous', 'Divine'] },
			{ name: 'Relic', prefixes: ['Forgotten', 'Tarnished', 'Ancient', 'Sacred', 'Transcendent'] },
			{ name: 'Sigil', prefixes: ['Cracked', 'Fading', 'Glowing', 'Burning', 'Eternal'] },
			{ name: 'Tear', prefixes: ['Opaque', 'Clouded', 'Shining', 'Crystallized', 'Astral'] },
			{ name: 'Ember', prefixes: ['Dying', 'Smoldering', 'Pulsing', 'Blazing', 'Immortal'] },
			{ name: 'Core', prefixes: ['Dormant', 'Unstable', 'Vibrant', 'Radiant', 'Omnipotent'] },
			{ name: 'Bloodstone', prefixes: ['Dull', 'Dark', 'Crimson', 'Pulsing', 'Godly'] },
			{ name: 'Halo Fragment', prefixes: ['Shattered', 'Dim', 'Golden', 'Blinding', 'Celestial'] },
		],
	},
};
