...
export const DB_NPC_ANIMALS = {
	...
	Hare: {
		...
		generationProfile: {
			...
			innateStrBounds: { min: 2, max: 5 },
			innateAgiBounds: { min: 5, max: 15 },
	...
	Moose: {
		...
		generationProfile: {
			...
			innateStrBounds: { min: 45, max: 50 },
			innateAgiBounds: { min: 35, max: 50 },
	...
	Dire_Wolf: {
		...
		generationProfile: {
			...
			innateAdpBounds: { min: 65, max: 105 },
			innateDdrBounds: { min: 30, max: 50 },
			innateStrBounds: { min: 45, max: 50 },
			innateAgiBounds: { min: 45, max: 50 },
			innateIntBounds: { min: 15, max: 20 },
		},
		interactions: { actionTags: ['Hunt_Animal', 'Fight_Animal', 'Ambush_Animal'] },
	},
	Grizzly_Bear: {
		...
		generationProfile: {
			...
			innateAdpBounds: { min: 80, max: 110 },
			innateDdrBounds: { min: 50, max: 65 },
			innateStrBounds: { min: 50, max: 50 },
			innateAgiBounds: { min: 45, max: 50 },
