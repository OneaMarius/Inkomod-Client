...
export const DB_NPC_ANIMALS = {
    ...
    Hare: {
        ...
        generationProfile: { rank: 1, baseHpBounds: { min: 11, max: 15 }, innateAdpBounds: { min: 0, max: 0 }, innateDdrBounds: { min: 0, max: 0 }, innateStrBounds: { min: 0, max: 1 }, innateAgiBounds: { min: 37, max: 50 }, innateIntBounds: { min: 3, max: 5 } },
    ...
    Pheasant: {
        ...
        generationProfile: { rank: 1, baseHpBounds: { min: 8, max: 12 }, innateAdpBounds: { min: 0, max: 0 }, innateDdrBounds: { min: 0, max: 0 }, innateStrBounds: { min: 0, max: 1 }, innateAgiBounds: { min: 30, max: 40 }, innateIntBounds: { min: 2, max: 4 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore'] },
    },
    ...
    Fox: {
        ...
        generationProfile: { rank: 2, baseHpBounds: { min: 18, max: 25 }, innateAdpBounds: { min: 7, max: 10 }, innateDdrBounds: { min: 3, max: 5 }, innateStrBounds: { min: 3, max: 5 }, innateAgiBounds: { min: 37, max: 50 }, innateIntBounds: { min: 15, max: 20 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore'] },
    },
    Deer: {
        ...
        generationProfile: { rank: 2, baseHpBounds: { min: 26, max: 35 }, innateAdpBounds: { min: 3, max: 5 }, innateDdrBounds: { min: 3, max: 5 }, innateStrBounds: { min: 11, max: 15 }, innateAgiBounds: { min: 37, max: 50 }, innateIntBounds: { min: 7, max: 10 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore'] },
    },
    ...
    Boar: {
        ...
        generationProfile: { rank: 3, baseHpBounds: { min: 45, max: 60 }, innateAdpBounds: { min: 26, max: 35 }, innateDdrBounds: { min: 26, max: 35 }, innateStrBounds: { min: 30, max: 40 }, innateAgiBounds: { min: 18, max: 25 }, innateIntBounds: { min: 3, max: 5 } },
    ...
    Wolf: {
        ...
        generationProfile: { rank: 3, baseHpBounds: { min: 37, max: 50 }, innateAdpBounds: { min: 33, max: 45 }, innateDdrBounds: { min: 18, max: 25 }, innateStrBounds: { min: 22, max: 30 }, innateAgiBounds: { min: 37, max: 50 }, innateIntBounds: { min: 11, max: 15 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore', 'Fight_Animal', 'Evade_Animal'] },
    },
    Elk: {
        ...
        generationProfile: { rank: 3, baseHpBounds: { min: 45, max: 65 }, innateAdpBounds: { min: 10, max: 15 }, innateDdrBounds: { min: 10, max: 15 }, innateStrBounds: { min: 25, max: 35 }, innateAgiBounds: { min: 30, max: 40 }, innateIntBounds: { min: 7, max: 12 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore', 'Fight_Animal', 'Evade_Animal'] },
    },
    ...
    Bear: {
        ...
        generationProfile: { rank: 4, baseHpBounds: { min: 60, max: 80 }, innateAdpBounds: { min: 56, max: 75 }, innateDdrBounds: { min: 33, max: 45 }, innateStrBounds: { min: 37, max: 50 }, innateAgiBounds: { min: 22, max: 30 }, innateIntBounds: { min: 7, max: 10 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore', 'Fight_Animal', 'Evade_Animal'] },
    },
    Moose: {
        ...
        generationProfile: { rank: 4, baseHpBounds: { min: 70, max: 90 }, innateAdpBounds: { min: 40, max: 55 }, innateDdrBounds: { min: 20, max: 30 }, innateStrBounds: { min: 45, max: 60 }, innateAgiBounds: { min: 15, max: 25 }, innateIntBounds: { min: 5, max: 8 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore', 'Fight_Animal', 'Evade_Animal'] },
    },
    Bison: {
        ...
        generationProfile: { rank: 4, baseHpBounds: { min: 80, max: 100 }, innateAdpBounds: { min: 30, max: 40 }, innateDdrBounds: { min: 40, max: 55 }, innateStrBounds: { min: 50, max: 70 }, innateAgiBounds: { min: 10, max: 20 }, innateIntBounds: { min: 4, max: 7 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore', 'Fight_Animal', 'Evade_Animal'] },
    },
    ...
    Dire_Wolf: {
        ...
        generationProfile: { rank: 5, baseHpBounds: { min: 90, max: 120 }, innateAdpBounds: { min: 65, max: 85 }, innateDdrBounds: { min: 30, max: 40 }, innateStrBounds: { min: 45, max: 60 }, innateAgiBounds: { min: 50, max: 65 }, innateIntBounds: { min: 15, max: 20 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore', 'Fight_Animal', 'Evade_Animal'] },
    },
    Grizzly_Bear: {
        ...
        generationProfile: { rank: 5, baseHpBounds: { min: 120, max: 150 }, innateAdpBounds: { min: 80, max: 100 }, innateDdrBounds: { min: 50, max: 65 }, innateStrBounds: { min: 60, max: 80 }, innateAgiBounds: { min: 30, max: 40 }, innateIntBounds: { min: 10, max: 15 } },
        interactions: { actionTags: ['Hunt_Animal', 'Ignore', 'Fight_Animal', 'Evade_Animal'] },
    },
    ...
    Chicken: {
        ...
        generationProfile: { rank: 1, baseHpBounds: { min: 5, max: 10 }, innateAdpBounds: { min: 0, max: 0 }, innateDdrBounds: { min: 0, max: 0 }, innateStrBounds: { min: 0, max: 1 }, innateAgiBounds: { min: 20, max: 30 }, innateIntBounds: { min: 1, max: 2 } },
    ...
    Goose: {
        ...
        generationProfile: { rank: 1, baseHpBounds: { min: 10, max: 15 }, innateAdpBounds: { min: 1, max: 3 }, innateDdrBounds: { min: 0, max: 2 }, innateStrBounds: { min: 2, max: 4 }, innateAgiBounds: { min: 15, max: 25 }, innateIntBounds: { min: 2, max: 4 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    ...
    Pig: {
        ...
        generationProfile: { rank: 2, baseHpBounds: { min: 30, max: 50 }, innateAdpBounds: { min: 3, max: 5 }, innateDdrBounds: { min: 7, max: 10 }, innateStrBounds: { min: 15, max: 20 }, innateAgiBounds: { min: 11, max: 15 }, innateIntBounds: { min: 5, max: 8 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    Sheep: {
        ...
        generationProfile: { rank: 2, baseHpBounds: { min: 25, max: 35 }, innateAdpBounds: { min: 0, max: 2 }, innateDdrBounds: { min: 3, max: 5 }, innateStrBounds: { min: 7, max: 12 }, innateAgiBounds: { min: 15, max: 20 }, innateIntBounds: { min: 3, max: 6 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    Goat: {
        ...
        generationProfile: { rank: 2, baseHpBounds: { min: 25, max: 35 }, innateAdpBounds: { min: 3, max: 5 }, innateDdrBounds: { min: 3, max: 5 }, innateStrBounds: { min: 11, max: 15 }, innateAgiBounds: { min: 22, max: 30 }, innateIntBounds: { min: 7, max: 10 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    ...
    Cow: {
        ...
        generationProfile: { rank: 3, baseHpBounds: { min: 50, max: 70 }, innateAdpBounds: { min: 3, max: 5 }, innateDdrBounds: { min: 11, max: 15 }, innateStrBounds: { min: 30, max: 45 }, innateAgiBounds: { min: 3, max: 5 }, innateIntBounds: { min: 3, max: 5 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    Ox: {
        ...
        generationProfile: { rank: 3, baseHpBounds: { min: 60, max: 80 }, innateAdpBounds: { min: 5, max: 10 }, innateDdrBounds: { min: 15, max: 20 }, innateStrBounds: { min: 40, max: 55 }, innateAgiBounds: { min: 2, max: 4 }, innateIntBounds: { min: 3, max: 5 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    ...
    Water_Buffalo: {
        ...
        generationProfile: { rank: 4, baseHpBounds: { min: 80, max: 110 }, innateAdpBounds: { min: 15, max: 25 }, innateDdrBounds: { min: 20, max: 30 }, innateStrBounds: { min: 50, max: 70 }, innateAgiBounds: { min: 2, max: 5 }, innateIntBounds: { min: 4, max: 6 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    Yak: {
        ...
        generationProfile: { rank: 4, baseHpBounds: { min: 70, max: 95 }, innateAdpBounds: { min: 10, max: 20 }, innateDdrBounds: { min: 15, max: 25 }, innateStrBounds: { min: 45, max: 60 }, innateAgiBounds: { min: 5, max: 10 }, innateIntBounds: { min: 4, max: 6 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    ...
    Prize_Bull: {
        ...
        generationProfile: { rank: 5, baseHpBounds: { min: 100, max: 130 }, innateAdpBounds: { min: 40, max: 60 }, innateDdrBounds: { min: 30, max: 40 }, innateStrBounds: { min: 60, max: 85 }, innateAgiBounds: { min: 10, max: 15 }, innateIntBounds: { min: 5, max: 8 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    Aurochs: {
        ...
        generationProfile: { rank: 5, baseHpBounds: { min: 110, max: 140 }, innateAdpBounds: { min: 45, max: 65 }, innateDdrBounds: { min: 35, max: 45 }, innateStrBounds: { min: 65, max: 90 }, innateAgiBounds: { min: 12, max: 18 }, innateIntBounds: { min: 6, max: 9 } },
        interactions: { actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal'] },
    },
    ...
    Horse: {
        ...
        logistics: {
            ...
            foodConsumption: 1,
            entityMassBounds: { min: 400, max: 600 }, 
            foodConversionFactor: 1.0, 
        },
        generationProfile: {
            rankRange: [1, 5],
            baseHp: 50,
        ...
        interactions: {
            actionTags: ['Slaughter_Animal', 'Sell_Animal', 'Buy_Animal', 'Steal_Animal', 'Mount_Animal', 'Dismount_Animal'],
        },
    },
};