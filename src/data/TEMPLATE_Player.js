...
export const TEMPLATE_PLAYER = {
    ...
    progression: {
        ...
        completedQuests: [], // Tracks finished quest IDs to prevent UI duplication
    },
    ...
    inventory: {
        ...
        // --------------------------------------------------------------------
        animalSlots: [], // Array of stored animal/livestock objects
        itemSlots: [], // Array of stored equippable gear
        lootSlots: [], // Array of non-equippable monster parts/trophies
        trophySlots: [], // Array for quest-specific unique items
    },
};