...
export const DB_NPC_NEPHILIMS = {
	...
	Scion_Of_Odin: {
		...
		interactions: {
			actionTags: ['Combat_Engage', 'Target_Bribe', 'Target_Assassination'],
		},
	},
	...
	Scion_Of_Thor: {
		...
		interactions: {
			actionTags: ['Combat_Engage', 'Combat_Duel', 'Target_Bribe'],
		},
	},
	...
	Scion_Of_Loki: {
		...
		interactions: {
			actionTags: ['Combat_Ambush', 'Target_Assassination', 'Target_Bribe'],
		},
	},
	...
	Scion_Of_Cronos: {
		classification: {
			...
			entityCategory: 'Nephilim',
			entityClass: 'Demigod',
			entitySubclass: 'Scion_Of_Cronos',
			entityRank: 5,
		},
		generationProfile: {
			socialClass: 'Divine',
