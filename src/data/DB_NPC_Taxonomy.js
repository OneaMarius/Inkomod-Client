...
export const DB_NPC_TAXONOMY = {
    ...
    Human: {
        ...
        subclasses: {
            ...
            Trade: [
                'Arms_Dealer', 'Armourer_Merchant', 'Shield_Seller', 'Horse_Dealer', 'Grazier', 'Provisioner', 'Grocer', 'Peddler', 'Banker', 'Caravan_Master',
            ],
...
Animal: {
    ...
    generationConfig: {
        ...
        baseFoodMult: 10,
        firstNames: [
            'Arthur', 'Cedric', 'Bjorn', 'Alaric', 'Gareth', 'Tristan', 'Roland', 'Ewan', 'Finn', 'Kael', 
            'Alden', 'Berengar', 'Cassian', 'Darian', 'Ealdred', 'Falk', 'Galahad', 'Halvar', 'Ivar', 'Jareth', 
            'Kaelen', 'Leif', 'Merrick', 'Njal', 'Orson', 'Percival', 'Quinlan', 'Ragnar', 'Soren', 'Theron', 
            'Ulric', 'Valerius', 'Wolfram', 'Xander', 'Yorick', 'Zane', 'Athelstan', 'Baldwin', 'Conrad', 'Duncan', 
            'Edric', 'Fenrir', 'Godric', 'Hademar', 'Ingvar', 'Jory', 'Kenric', 'Lothar', 'Malric', 'Norward', 
            'Oswin', 'Rurik', 'Stellan', 'Torsten', 'Uhtred',
        ],
        lastNames: [
            'Ironhand', 'Blackwood', 'Vance', 'Sterling', 'Locke', 'Frost', 'Stone', 'Rivers', 'Pyke', 'Snow', 
            'Ashdown', 'Bloodgood', 'Crow', 'Darkmoor', 'Ember', 'Flint', 'Graves', 'Hawthorne', 'Ironclad', 'Storm', 
            'Nightbane', 'Oakenshield', 'Pine', 'Ravenscroft', 'Silver', 'Thorn', 'Underwood', 'Whitewood', 'Wyrm', 'Yronwood', 
            'Aldridge', 'Bainbridge', 'Caldwell', 'Dalton', 'Edge', 'Fairburn', 'Galt', 'Harwood', 'Ingrams', 'Karstark', 
            'Langdon', 'Mercer', 'Nash', 'Osgood', 'Penrose', 'Quintrell', 'Redfort', 'Stark', 'Tully', 'Umber', 
            'Vex', 'Weaver', 'Yarwood', 'Thorne', 'Swift',
        ],
