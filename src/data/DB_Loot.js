...
export const DB_LOOT = {
	...
	// ------------------------------------------------------------------------
	lootTables: {
		table_animal_base: { itemId: 'item_animal_loot' },

		table_monster_base: { itemId: 'item_monster_loot' },

		table_human_base: { itemId: 'item_human_loot' },

		table_nephilim_base: { itemId: 'item_nephilim_loot' },
	},
};
