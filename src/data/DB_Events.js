...
export const DB_EVENTS = {
	events: [
			...
			choices: [
				{
					...
					difficultyModifier: 1,
					onSuccess: {
						description: 'You scramble up a trunk just in time. The animal loses interest and leaves.',
						apMod: { tier: 'MINOR', type: 'PENALTY' },
						agi: { tier: 'MINOR', type: 'REWARD' },
						renown: { tier: 'MINOR', type: 'REWARD' },
					},
					onFailure: {
						description: 'You slip, dropping some supplies as you scramble away in panic.',
						apMod: { tier: 'MINOR', type: 'PENALTY' },
				...
				},
				{
					...
					onFailure: {
						description: 'Your attempt fails to scare it off. You run, losing items in the process.',
						apMod: { tier: 'MINOR', type: 'PENALTY' },
						food: { tier: 'MINOR', type: 'PENALTY' },
					},
				},
			...
			choices: [
				{
					...
					difficultyModifier: 2,
					onSuccess: {
						description: 'You roll through the brush, breaking line of sight through sheer agility.',
						apMod: { tier: 'MODERATE', type: 'PENALTY' },
						agi: { tier: 'MINOR', type: 'REWARD' },
						renown: { tier: 'MODERATE', type: 'REWARD' },
					},
					onFailure: {
						description: 'The monster chases you down. You narrowly escape, losing significant supplies.',
						apMod: { tier: 'MODERATE', type: 'PENALTY' },
				...
				},
				{
					...
					successChance: 25,
					onSuccess: {
						description: 'The predator sniffs you and loses interest, moving back into the shadows.',
						renown: { tier: 'MINOR', type: 'REWARD' },
					},
					onFailure: {
						description: 'It does not fall for the ruse. You run for your life, dropping your provisions.',
						apMod: { tier: 'MODERATE', type: 'PENALTY' },
						food: { tier: 'MODERATE', type: 'PENALTY' },
					},
				},
			...
			choices: [
				{
					...
					difficultyModifier: 2,
					onSuccess: {
						description: 'You block its mental intrusion long enough to escape its domain.',
						apMod: { tier: 'MAJOR', type: 'PENALTY' },
						int: { tier: 'MINOR', type: 'REWARD' },
						renown: { tier: 'MAJOR', type: 'REWARD' },
					},
					onFailure: {
						description: 'The entity shatters your focus. You flee in terror, abandoning your gear.',
						apMod: { tier: 'MAJOR', type: 'PENALTY' },
				...
				},
				{
					...
					successChance: 15,
					onSuccess: {
						description: 'You stumble blindly into a sacred grove where the entity cannot follow.',
						renown: { tier: 'MODERATE', type: 'REWARD' },
					},
					onFailure: {
						description: 'You run straight into its path and are forced to flee in panic, dropping everything.',
						apMod: { tier: 'MAJOR', type: 'PENALTY' },
						food: { tier: 'MAJOR', type: 'PENALTY' },
					},
				},
		...
		},
		{
			...
			staticEffects: null,
			onEncounter: { procGen: { type: 'NPC_HUMAN', categories: ['Human'], classes: ['Resources'], rankModifier: 0 } },
			choices: [
		...
		},
		{
			...
			conditions: { weight: 50, minRank: 1, allowedTriggers: ['travel', 'explore'], allowedZoneSubclasses: ['Orbit', 'Wild', 'Edge', 'Village'] },
			staticEffects: null,
			onEncounter: { procGen: { type: 'NPC_HUMAN', categories: ['Human'], classes: ['Transport'], rankModifier: 0 } },
			choices: [
		...
		},
		{
			...
			staticEffects: null,
			onEncounter: { procGen: { type: 'NPC_HUMAN', categories: ['Human'], classes: ['Knowledge'], rankModifier: 0 } },
			choices: [
		...
		},
		{
			...
			staticEffects: null,
			onEncounter: { procGen: { type: 'NPC_HUMAN', categories: ['Human'], classes: ['Society'], rankModifier: -1 } },
			choices: [
		...
		},
		{
			...
			staticEffects: null,
			onEncounter: { procGen: { type: 'NPC_HUMAN', categories: ['Human'], classes: ['Religion'], rankModifier: 0 } },
			choices: [
		...
		},
		{
			...
			staticEffects: null,
			onEncounter: { procGen: { type: 'NPC_HUMAN', categories: ['Human'], classes: ['Resources'], subclasses: ['Horse_Breeder'], rankModifier: 0 } },
			choices: [
		...
		},
		{
			...
			staticEffects: null,
			onEncounter: { procGen: { type: 'NPC_HUMAN', categories: ['Human'], classes: ['Resources'], subclasses: ['Shepherd'], rankModifier: 0 } },
			choices: [
